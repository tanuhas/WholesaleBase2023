...
public class WarehouseAdapter extends FirebaseRecyclerAdapter<WarehousesModel, WarehouseAdapter.myViewHolder>{
     ...
     * @param options
     */
    public WarehouseAdapter(@NonNull FirebaseRecyclerOptions<WarehousesModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull WarehousesModel model) {
          ...
          holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final DialogPlus dialogPlus= DialogPlus.newDialog(holder.adres.getContext())
                        .setContentHolder(new ViewHolder(R.layout.update_warehouse))
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Warehouses")
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.warehouse_item,parent,false);
