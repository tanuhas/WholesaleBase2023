...
public class AddWarehouseActivity extends AppCompatActivity {
    ...
    private void insertData()
    {
        ...
        FirebaseDatabase.getInstance().getReference().child("Warehouses").push()
                .setValue(map)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        Toast.makeText(AddWarehouseActivity.this, "Данные успешно добавлены!", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure( Exception e) {
                        Toast.makeText(AddWarehouseActivity.this, "Ошибка...", Toast.LENGTH_SHORT).show();
                    }
                });
    }
