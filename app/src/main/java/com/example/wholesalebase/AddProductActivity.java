        ...
        FirebaseDatabase.getInstance().getReference().child("Products").push()
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(AddProductActivity.this, "Данные успешно добавлены!", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure( Exception e) {
                        Toast.makeText(AddProductActivity.this, "Ошибка...", Toast.LENGTH_SHORT).show();
                    }
                });
    }
