...
public class ProductAdapter extends FirebaseRecyclerAdapter<ProductsModel,ProductAdapter.myViewHolder>{
     ...
     * @param options
     */
    public ProductAdapter(@NonNull FirebaseRecyclerOptions<ProductsModel> options) {
        super(options);
    }
